...
popsize=100;   %群体大小
goods_num=88;  %88个货物
goods_kind=40; %40种类货物
goods_pos=12;  %每个货物的位置，2位货区，4位排数，4位列数，2位层数
goods_Vv=2;    %小车水平速度
goods_Vy=0.5;  %小车竖直速度
layer_height=0.8;%货位高度0.8m
...
%grid on
%end
result_plan1=result_plan(:,1).*1000+result_plan(:,2).*100+result_plan(:,3).*10+result_plan(:,4);%最后的最优个体，即最优分配方式
toc