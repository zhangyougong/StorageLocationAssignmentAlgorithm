...
% goods_gravity_least=Inf;
% goods_time_least=Inf;
%%%%%%%%%%%%%%%计算各种布局方式（染色体）的总重心%%%%%%%%%%%%%%%
for i=1:popsize
    for j=1:goods_num
...
%       if(goods_gravity_all(i)<goods_gravity_least)
%           goods_gravity_least=goods_gravity_all(i);
%       end
end
%     if (goods_gravity_least<goods_gravity_least_generation)
%         goods_gravity_least_generation=goods_gravity_least;
%     end
%%%%%%%%%%%%%%%计算种群中每个物体的时间%%%%%%%%%%%%%%%
for i=1:pop_length
